...
class RepresentationAdv():
    ...
    def get_loss(self, npts, partial_input, coarse_gt, dense_gt, pd, 
        ...
        with torch.enable_grad():
            ...
            for _iter in range(self.max_iters):
                ...
                proj_grads = torch.einsum('bij,bij->bi', (grads.data.permute(0,2,1), pd)).unsqueeze(2).expand(1, n, 3)*pd

                x.data += self.beta * proj_grads.permute(0,2,1)
